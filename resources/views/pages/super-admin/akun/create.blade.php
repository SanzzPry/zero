...
@section('content')
    ...
    <div class="px-20 py-2">
        <div class="bg-white border rounded-xl px-11 py-2">
            <h2 class="text-xl text-center mb-3">Buat Akun Baru</h2>
            ...
            <form action="{{ route('akun.store') }}" method="POST" enctype="multipart/form-data">
                ...
                alt="Profile Photo"
                class="w-24 h-24 rounded-full object-cover border-4 border-gray-200 shadow mb-3"> <label
                    class="cursor-pointer inline-flex items-center justify-center px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium rounded-md shadow">
    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="user_display" value="" class="mt-1 block w-full rounded-md border px-3 py-2">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Password</label>
                <input type="password" name="password" value="" class="mt-1 block w-full rounded-md border px-3 py-2">
            </div>
        </div>
        ...
        {{-- <!-- Row 3: Provinsi, Kota, Kecamatan -->
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                                                <div class="col-start-2">
                                                    ...
                                                    <input type="text" name="desa" value="" class="mt-1 block w-full rounded-md border px-3 py-2">
                                                </div>
                                                <div>
                                            ...
                                            <div>
                                                ...
                                                <textarea rows="3" name="detail_alamats"
